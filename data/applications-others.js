...
exports.OTHERS = {
    ...
    [BrowserType.APP_MEDIAPLAYER]:  [
        ...
        { name: 'SubStream',            id: 'substream',         regexp: /SubStream\/([0-9.]*)/u, type: DeviceType.MOBILE },
        ...
        { name: 'Boxee',                id: 'boxee',             regexp: /Boxee(?:\/([0-9.]*))?/u, type: DeviceType.TELEVISION },
        { name: 'Kodi',                 id: 'kodi',              regexp: /^Kodi\/([0-9.]+)/u, details: 2 },
        { name: 'XBMC',                 id: 'xbmc',              regexp: /^XBMC\/(?:PRE-)?([0-9.]+)/u, details: 2 },
    ],

    [BrowserType.APP_EMAIL]:  [
        { name: 'Lightning',            id: 'lightning',      regexp: /Lightning\/([0-9.]*)/u },
        { name: 'Thunderbird',          id: 'thunderbird',      regexp: /Thunderbird[\/ ]([0-9.]*)/u, type: DeviceType.DESKTOP },
        { name: 'Microsoft Outlook',    id: 'outlook',      regexp: /Microsoft Outlook IMO, Build ([0-9.]*)/u, details: 2, type: DeviceType.DESKTOP },
        { name: 'Microsoft Outlook',    id: 'outlook',      regexp: /Microsoft Outlook ([0-9.]*)/u, details: 2, type: DeviceType.DESKTOP },
        { name: 'Microsoft Outlook Express',    id: 'outlook',      regexp: /Outlook-Express\/([0-9.]*)/u, details: 2, type: DeviceType.DESKTOP },
        { name: 'Lotus Notes',          id: 'lotus',      regexp: /Lotus-Notes\/([0-9.]*)/u, details: 2, type: DeviceType.DESKTOP },
    ...
    [BrowserType.APP_FEEDREADER]:  [
        ...
        { name: 'NewsBlur',             id: 'news',      regexp: /NewsBlur\/([0-9.]*)/u, type: DeviceType.MOBILE },
        ...
        { name: 'ReedKit',              id: 'reedkit',      regexp: /ReedKit\/([0-9.]*)/u, type: DeviceType.DESKTOP },
    ...
    [BrowserType.APP_PODCAST]:  [
        { name: 'Ziepod',              id: 'ziepod',      regexp: /Ziepod\+? ([0-9.]*)/u },
    ],

    [BrowserType.APP_CHAT]:  [
    ...
    [BrowserType.APP_EDITOR]:  [
        ...
        { name: 'Microsoft FrontPage',  id: 'frontpage',      regexp: /MS ?FrontPage[ \/]([0-9.]*)/u, details: 2, type: DeviceType.DESKTOP },
        { name: 'W3C Amaya',            id: 'amaya',      regexp: /amaya\/([0-9.]*)/u },
    ],

    [BrowserType.APP_DOWNLOAD]:  [
        { name: 'Download Manager',     id: 'download',      regexp: /AndroidDownloadManager\//u },
    ],

    [BrowserType.APP_GAME]:  [
